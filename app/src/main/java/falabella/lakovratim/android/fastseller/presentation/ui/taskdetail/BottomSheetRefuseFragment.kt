...
import falabella.lakovratim.android.fastseller.databinding.BottomSheetRefuseFragmentBinding

class BottomSheetRefuseFragment  : BottomSheetDialogFragment() {
    private var _binding: BottomSheetRefuseFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = BottomSheetRefuseFragmentBinding.inflate(
            inflater,
            container,
            false
        )
